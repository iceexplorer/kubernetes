...
if [[ "$NEW_VERSION" == "1.31.0" ]]; then
    echo "Kubernetes node successfully upgraded to v1.31.0"
else
...
echo "Upgrade process completed. Note: This script used the recommended Kubernetes repository for v1.31.0."
