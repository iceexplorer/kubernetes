...
# From version 1.28.9 to 1.30.4, using the recommended Kubernetes repository
...
echo "Upgrading kubeadm to v1.30.4..."
apt-get update && apt-get install -y kubeadm='1.30.4-*'

# Hold kubeadm at the new version
echo "Holding kubeadm at version 1.30.4..."
...
if [[ "$NEW_VERSION" == "v1.30.4" ]]; then
    echo "Kubernetes control-plane successfully upgraded to v1.30.4"
else
